...
function () {
  mask.stop().animate({ transform: 't-' + (width + maskOffset) + ',0' }, 350, mina.easeout, function () {return mask.attr('stroke-width', 0);});
  maskInvert.stop().animate({ transform: 't0,0' }, 350, mina.easeout);
});


svg.click(function () {return btn.click();});
